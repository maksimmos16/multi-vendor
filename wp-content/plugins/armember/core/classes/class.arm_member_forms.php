...
if (!class_exists('ARM_member_forms')) {
    ...
    margin-left: 10px;position: absolute;"></div>';
	    ...
	    if(strpos($id,' ')===false)
	    {
            ...
            if ($type == 'prefix') {
                $icon .= '<span class="arm-df__fc-icon --arm-prefix-icon" id="arm_editor_prefix_' . $field_id . '" style="' . $iconStyle . '"><i class="' . $id . '"></i></span>';
            } elseif ($type == 'suffix') {
                $icon .= '<span class="arm-df__fc-icon --arm-suffix-icon" id="arm_editor_suffix_' . $field_id . '" style="' . $iconStyle . '"><i class="' . $id . '"></i></span>';
            }
            return $icon;
        }
        ...
        function arm_member_form_get_fields_by_type($field_options, $field_id = 0, $form_id = 0, $form_type = 'inactive', $form = '', $formRandomID = '') {
                    ...
                    if (!empty($value['options'])) {
                        ...
                        else 
                        {
                            ...
                            foreach ($value['options'] as $data) {
                                ...
                                if (!empty($required)) {
                                    $arm_field_chkbox_msg_required = (!empty($value['blank_message'])) ? $value['blank_message'] : _e('Please check atleast one option', 'ARMember');
            ...
            if (!empty($output)) {
                ...
                $return_html = '<div class="arm-df__form-field-wrap_' . $value['type'] . ' arm-df__form-field-wrap arm-controls'.$ffield_type_class.'" id="arm-df__form-field-wrap_' . $field_id . '">' . $output . '</div>'.$helper_description;
                $return_html .= $psm;
            }
            return $return_html;
        }
	    		...
	    		if(is_admin())
			{
                ...
                $new_style_css .= "
                        ...
                        */
						...
						$container.arm-material-style .arm-df__checkbox input[type='checkbox'] + label:after,
                        $container.arm-material-style .arm-df__radio input[type='radio'] + label:before,
                        $container.arm--material-outline-style .arm-df__checkbox input[type='checkbox'],
                        $container.arm--material-outline-style .arm-df__radio input[type='radio']
                        {
							border-color: " . $new_style['field_border_color'] . ";
						}
                        ...
                        $container.arm-material-style .arm-df__checkbox input[type='checkbox']:checked + label:after,
                        $container.arm-material-style .arm-df__checkbox input[type='checkbox']:checked:focus + label:after,
                        $container.arm-material-style .arm-df__radio input[type='radio']:checked + label:after,
                        $container.arm-material-style .arm-df__radio input[type='radio']:checked:focus + label:after{
							background-color: " . $new_style['field_focus_color'] . ";
                            border-color: " . $new_style['field_focus_color'] . ";
						}
                        $container.arm-material-style .arm-df__radio input[type='radio']:checked + label:before {
                            border-color: " . $new_style['field_focus_color'] . ";
                        }
						...
						$container.arm_form_layout_writer .arm-df__form-field-wrap input,
						$container.arm_form_layout_writer .arm-df__form-field-wrap select{
							-webkit-transition: all 0.3s cubic-bezier(0.64, 0.09, 0.08, 1);
							transition: all 0.3s cubic-bezier(0.64, 0.09, 0.08, 1);
