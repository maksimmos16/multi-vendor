                                                        ...
                                                        function arm_hide_update_notice()
{
    ...
    function arm_new_version_changelog() {
        ...
        $arm_change_log = array(
            ...
            'critical_title' =>'Version 5.5 Changes',
            'critical' =>array(
                        "A complete revamp of ARMember Login/Signup & Setup Forms UI",
                        "Added New Theme: 'Material Outline'",
                        "Updated Google Sign-in social login with New Method",
                        "Added 'Verify Webhook' feature for Stripe Payment Gateway",
